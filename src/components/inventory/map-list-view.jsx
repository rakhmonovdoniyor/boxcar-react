...
import InventoryListingListSection from "./listing-list";
import {
  InventoryHeroShell,
  InventoryPageButton,
  InventoryPageShell,
...
const InventoryMapListViewPage = () => {
        ...
        <InventorySplitSurface>
          <InventorySplitLayout>
            <InventorySplitLeft>
              ...
              <InventoryListingListSection compact listings={paginatedListings} />
            ...
            <InventorySplitMap>
              <InventoryMapLabel $left="11%" $top="30%">
                $28,000
              </InventoryMapLabel>
              <InventoryMapLabel $left="25%" $top="68%">
                $32,900
              </InventoryMapLabel>
              <InventoryMapLabel $left="46%" $top="43%" $active>
                $41,750
              </InventoryMapLabel>
              <InventoryMapLabel $left="77%" $top="62%">
                $56,100
              </InventoryMapLabel>
...
export default InventoryMapListViewPage;
